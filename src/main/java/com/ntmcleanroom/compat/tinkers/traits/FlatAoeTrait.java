 ...
 * {@link VeinMinerTrait}/{@link AoeTrait} for the tool's single "area ability" slot (see
 * {@link AbilitySlots}).
 */
public class FlatAoeTrait extends AbstractTrait implements CompetingAreaTrait {
    ...
    public FlatAoeTrait(String identifier, int radius, int hbmLevel) {
    ...
    public IToolAreaAbility getAreaAbility() {
        return IToolAreaAbility.HAMMER_FLAT;
    }
